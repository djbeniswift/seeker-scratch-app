                        ...
                        <div>
                          ...
                          {freePlayTimeLeft === 0 ? (
                            <>
                              ...
                              <div style={{ fontSize: 10, color: 'rgba(255,255,255,0.45)', fontFamily: 'monospace', marginTop: 2 }}>Requires a small SOL balance (~0.001–0.005 SOL) for the network fee.</div>
                            </>
                          ) : (
